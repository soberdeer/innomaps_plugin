...
if (function (e, t) {
        var n = {
            init: function () {
                ...
                var t = Array.prototype.slice.call(e.data, 1), n = e.data[0], r = tree[n].apply(tree, t);
                postMessage([n, r])
            }, setup: function (t) {
                var r = e.URL || e.webkitURL, a = "var tree = {" + this.parse(t).join(",") + "};", s = new Blob([a + 'self.addEventListener("message", ' + this.work_handler.toString() + ", false);"], {type: "text/javascript"}), o = new Worker(r.createObjectURL(s));
                return o.onmessage = function (e) {
                    var t = Array.prototype.slice.call(e.data, 1), r = e.data[0];
                    n.observer.emit("x10:" + r, t)
                }, o
            }, call_handler: function (e, t) {
                return function () {
                    var r = Array.prototype.slice.call(arguments, 0, -1), a = arguments[arguments.length - 1];
                    r.unshift(e), n.observer.on("x10:" + e, function (e) {
                        a(e.detail[0])
                    }), t.postMessage(r)
                }
            }, compile: function (e) {
                var t, n = this.setup("function" == typeof e ? {func: e} : e), r = {};
                if ("function" == typeof e)return r.func = this.call_handler("func", n), r.func;
                for (t in e)r[t] = this.call_handler(t, n);
                return r
            }, parse: function (e, n) {
                var r, a, s, o = [];
                for (r in e)if (s = e[r], null !== s)if (s !== t) {
                ...
                } else o.push(r + ":undefined"); else o.push(r + ":null");
                return o
            }, observer: function () {
                var e = {};
                return {
                    on: function (t, n) {
                        ...
                        if (e[t])for (var r = {
                            type: t, detail: n, isCanceled: !1, cancelBubble: function () {
                                this.isCanceled = !0
                            }
                        }, a = e[t].length; a--;) {
        ...
        var r = {
            ...
            tabsize: 4,
            render: function (e, t) {
                var n, r, a, s, o = new XSLTProcessor, i = document.createElement("span"), l = {match: "/"};
                switch (typeof e) {
                    case"object":
                ...
                if (l.data = JSON.toXML(l.data), n = '//xsl:template[@name="' + l.template + '"]', this.xsl_template || this.gatherTemplates(), l.sorter && (s = this.node.selectSingleNode(this.xsl_template, n + "//xsl:for-each//xsl:sort"), s && (l.sorter.order && s.setAttribute("order", l.sorter.order), l.sorter.select && s.setAttribute("select", l.sorter.select), s.setAttribute("data-type", l.sorter.type || "text"))), a = this.node.selectSingleNode(this.xsl_template, n), a.setAttribute("match", l.match), o.importStylesheet(this.xsl_template), i.appendChild(o.transformToFragment(l.data, document)), a.removeAttribute("match"), this.is_safari) {
                    ...
                    for (var c = 0, u = r.length; u > c; c++)r[c].defer = !0
                }
                return i.innerHTML
            },
            gatherTemplates: function () {
                for (var e = document.getElementsByTagName("script"), t = "", n = 0, r = e.length; r > n; n++)"defiant/xsl-template" === e[n].type && (t += e[n].innerHTML);
            ...
            xmlFromString: function (e) {
                var t, n;
                return e = e.replace(/>\s{1,}</g, "><"), null === e.trim().match(/<\?xml/) && (e = this.xml_decl + e), this.is_ie ? (n = new ActiveXObject("Msxml2.DOMDocument"), n.loadXML(e), -1 === e.indexOf("xsl:stylesheet") && n.setProperty("SelectionLanguage", "XPath")) : (t = new DOMParser, n = t.parseFromString(e, "text/xml")), n
            },
            extend: function (e, t) {
    ...
    XSLTProcessor.prototype = {
        importStylesheet: function (e) {
            ...
            var n = e.transformNode(this.xsldoc), r = document.createElement("span");
...
String.prototype.fill || (String.prototype.fill = function (e, t) {
    ...
    var e = this;
    return -1 === this.indexOf("translate(") && (e = this.replace(/contains\(([^,]+),([^\\)]+)\)/g, function (e, t, n) {
    ...
    var n, r, a, s = {
        ...
        hash_to_xml: function (e, t, n) {
            var r, a, s, o, i, l, c, u, d, h = t.constructor === Array, m = this, p = [], f = [], g = function (t, r) {
                if (a = r[t], (null === a || void 0 === a || "NaN" === a.toString()) && (a = null), o = "@" === t.slice(0, 1), i = n ? e : t, i == +i && r.constructor !== Object && (i = "d:item"), null === a ? (l = null, c = !1) : (l = a.constructor, c = l.toString().match(m.rx_function)[1]), o)f.push(i.slice(1) + '="' + m.escape_xml(a) + '"'), "String" !== c && f.push("d:" + i.slice(1) + '="' + c + '"'); else if (null === a)p.push(m.scalar_to_xml(i, a)); else switch (l) {
                    case Function:
                        throw"JSON data should not contain functions. Please check jour structure.";
                    case Object:
                        p.push(m.hash_to_xml(i, a));
                        break;
                    case Array:
                        if (t === i) {
                            if (s = a.constructor === Array)for (u = a.length; u--;)null !== a[u] && a[u] && a[u].constructor !== Array || (s = !0), s || a[u].constructor !== Object || (s = !0);
                            p.push(m.scalar_to_xml(i, a, s));
                            break
                        }
                    case String:
                        if ("string" == typeof a && (a = a.toString().replace(/\&/g, "&amp;").replace(/\r|\n/g, "&#13;")), "#text" === i) {
                            m.map.push(r), f.push('d:mi="' + m.map.length + '"'), f.push('d:constr="' + c + '"'), p.push(m.escape_xml(a));
                            break
                        }
                    case Number:
                    case Boolean:
                        ...
                        p.push(m.scalar_to_xml(i, a))
                }
            };
            if (t.constructor === Array)for (u = 0, d = t.length; d > u; u++)g(u.toString(), t); else for (r in t)g(r, t);
            return e || (e = "d:data", f.push(this.namespace), h && f.push('d:constr="Array"')), null === e.match(this.rx_validate_name) && (f.push('d:name="' + e + '"'), e = "d:name"), n ? p.join("") : (this.map.push(t), f.push('d:mi="' + this.map.length + '"'), "<" + e + (f.length ? " " + f.join(" ") : "") + (p.length ? ">" + p.join("") + "</" + e + ">" : "/>"))
        },
        scalar_to_xml: function (e, t, n) {
            ...
            if (1 === t.length && t[0].constructor === Object) {
                ...
                var i = r.match(this.rx_node), l = r.match(this.rx_constructor);
    ...
    switch (typeof t) {
        ...
        case"boolean":
            return n = s.to_xml_str.call(s, e), {doc: Defiant.xmlFromString(n.str), src: e, map: n.map};
        default:
    ...
    "use strict";
    var r, a, s = e.doc && e.doc.nodeType, o = s ? e.doc : JSON.toXML(e), i = s ? e.map : this.search.map, l = s ? e.src : e, c = Defiant.node[n ? "selectSingleNode" : "selectNodes"](o, t.xTransform()), u = [];
    ...
    "use strict";
    for (var r, a, s, o, i, l = window, c = JSON.stringify, u = c(e, null, "	").replace(/\t/g, ""), d = [], h = 0, m = n.length, p = m ? n[h].ownerDocument.documentElement : !1, f = (this.search.map, 0); m > h; h++) {
        switch (n[h].nodeType) {
            case 2:
    ...
    if (e.evaluate) {
        for (var n = e.createNSResolver(e.documentElement), r = e.evaluate(t, e, n, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null), a = [], s = 0, o = r.snapshotLength; o > s; s++)a.push(r.snapshotItem(s));
        return a
    }
    ...
    var t, n, r = Defiant, a = r.tabsize, s = r.xml_decl.toLowerCase();
    r.is_ie ? n = e.xml : (t = new XMLSerializer, n = t.serializeToString(e)), "development" !== r.env && (n = n.replace(/ \w+\:d=".*?"| d\:\w+=".*?"/g, ""));
    for (var o, i, l = n.trim().replace(/(>)\s*(<)(\/*)/g, "$1\n$2$3"), c = l.split("\n"), u = -1, d = 0, h = c.length; h > d; d++)(0 !== d || c[d].toLowerCase() !== s) && (o = null !== c[d].match(/<[A-Za-z_\:]+.*?>/g), i = null !== c[d].match(/<\/[\w\:]+>/g), null !== c[d].match(/<.*?\/>/g) && (o = i = !0), o && u++, c[d] = String().fill(u, "	") + c[d], o && i && u--, !o && i && u--);
    return c.join("\n").replace(/\t/g, String().fill(a, " "))
}, Defiant.node.toJSON = function (e, t) {
    "use strict";
    var n = function (e) {
        var t, r, a, s, o, i, l, c, u, d, h = {}, m = window;
        switch (e.nodeType) {
            case 1:
                for (o = e.getAttribute("d:constr"), "Array" === o ? h = [] : "String" === o && "" === e.textContent && (h = ""), t = e.attributes, c = 0, u = t.length; u > c; c++)d = t.item(c), null === d.nodeName.match(/\:d|d\:/g) && (o = e.getAttribute("d:" + d.nodeName), i = o && "undefined" !== o ? "null" === d.nodeValue ? null : m[o]("false" === d.nodeValue ? "" : d.nodeValue) : d.nodeValue, h["@" + d.nodeName] = i);
                break;
            case 3:
                r = e.parentNode.getAttribute("d:type"), i = r ? m[r]("false" === e.nodeValue ? "" : e.nodeValue) : e.nodeValue, h = i
        }
        if (e.hasChildNodes())for (c = 0, u = e.childNodes.length; u > c; c++)if (a = e.childNodes.item(c), s = a.nodeName, t = e.attributes, "d:name" === s && (s = a.getAttribute("d:name")), "#text" === s)o = e.getAttribute("d:constr"), "undefined" === o && (o = void 0), l = a.textContent || a.text, i = "Boolean" === o && "false" === l ? "" : l, o || t.length ? o && 1 === u ? h = m[o](i) : e.hasChildNodes() && t.length < 3 ? h = o ? m[o](i) : i : h[s] = o ? m[o](i) : i : h = i; else {
            ...
            switch (o = a.getAttribute("d:constr")) {
                ...
                case"Number":
                case"Boolean":
                    l = a.textContent || a.text, i = "Boolean" === o && "false" === l ? "" : l, h.push ? h.push(m[o](i)) : h[s] = n(a);
                    break;
                default:
    ...
    }, r = 9 === e.nodeType ? e.documentElement : e, a = n(r), s = a[r.nodeName];
